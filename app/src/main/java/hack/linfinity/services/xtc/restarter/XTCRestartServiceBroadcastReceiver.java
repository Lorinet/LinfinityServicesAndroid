...
public class XTCRestartServiceBroadcastReceiver extends BroadcastReceiver {
    public static final String TAG = XTCRestartServiceBroadcastReceiver.class.getSimpleName();
    private static JobScheduler jobScheduler;
    private XTCRestartServiceBroadcastReceiver restartSensorServiceReceiver;
    ...
    private void registerRestarterReceiver(final Context context) {
        ...
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                filter.addAction(XTCJobService.RESTART_INTENT);
                try {
