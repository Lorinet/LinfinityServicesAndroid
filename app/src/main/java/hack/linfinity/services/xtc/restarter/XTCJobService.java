...
package hack.linfinity.services.xtc.restarter;
...
public class XTCJobService extends android.app.job.JobService {
    private static String TAG= XTCJobService.class.getSimpleName();
    public static final String RESTART_INTENT = "hack.linfinity.xtc.restarter";
    private static XTCRestartServiceBroadcastReceiver restartSensorServiceReceiver;
    private static XTCJobService instance;
    ...
    public boolean onStartJob(JobParameters jobParameters) {
        ...
        instance= this;
        XTCJobService.jobParameters= jobParameters;
    ...
    private void registerRestarterReceiver() {
        ...
        if (restartSensorServiceReceiver == null)
            restartSensorServiceReceiver = new XTCRestartServiceBroadcastReceiver();
        else try{
